...
async def generate(request: Request) -> Response:
    ...
    # Drop benchmark-injected keys (e.g. best_of, use_beam_search) that
    # SamplingParams does not accept.
    _KNOWN_SAMPLING_KEYS = {
        "do_sample", "presence_penalty", "frequency_penalty",
        "temperature", "top_p", "top_k", "ignore_eos",
        "max_new_tokens", "stop_sequences",
    }
    sample_params_dict = {k: v for k, v in sample_params_dict.items()
