...
class AdapterSlotsBackend(BaseBackend):
    ...
    def _server_env(self) -> dict:
        ...
        # Overrides for knobs that must be re-calibrated per model size
        # (an MWC delta is ~4.3GB/adapter at 7B but ~8.4GB at 13B).
        import os as _os
        for _k in ("AS_MWC_K_HOT", "AS_MACRO_N_ACCUM", "AS_SEGGEMM",
                   "AS_SEGGEMM_MIN_TOKENS"):
