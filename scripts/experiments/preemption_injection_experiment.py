"""
preemption_injection_experiment.py -- AB7: Preemption Injection Experiment (multi_gpu_correctness, §5.3)

Validates Theorem 8.11:
...
-----
    ...
    python scripts/experiments/preemption_injection_experiment.py \\
        --mode cpu \\
    ...
    CUDA_VISIBLE_DEVICES=0,1 python scripts/experiments/preemption_injection_experiment.py \\
        --mode two_a6000_pcie \\
        --K 4 --W 32 --lambda-total 14 \\
        --tau-iter-ms 100 \\
        --n-ticks 4000 \\
...
Outputs
-------
    results/multi_gpu_correctness/preemption_injection_experiment.csv          -- full results table
    results/multi_gpu_correctness/ab7_preemption_summary.txt  -- PASS/FAIL verdict + theorem check
"""
...
def simulate_ab7(
    ...
    Model (§5.3 of multi_gpu_correctness.md):
...
def run_ab7(
    ...
    # Write CSV
    csv_path = os.path.join(output_dir, "preemption_injection_experiment.csv")
