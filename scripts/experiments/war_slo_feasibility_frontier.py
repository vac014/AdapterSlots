"""
war_slo_feasibility_frontier.py -- WAR-SLO feasibility frontier sweep (Experiment 6.3 / 6.6d)
...
Usage (Single A6000, K=4):
    python scripts/experiments/war_slo_feasibility_frontier.py \
        ...
        --output results/erlang_scheduler/a6000_single/war_slo_frontier.csv \
        --duration 300
...
Usage (Two H100 NVLink, K=4, for cross-hardware comparison):
    python scripts/experiments/war_slo_feasibility_frontier.py \
        ...
        --dataset-path ./data/sharegpt/sharegpt.jsonl \
        --output results/erlang_scheduler/two_h100_nvlink/war_slo_frontier_nvlink.csv \
...
def run_simulate(args):
    ...
    arrivals. This matches the parameterisation used in fairness_starvation_ablation.py --mode simulate.
...
def main():
    ...
    parser.add_argument("--output", required=True,
                        help="Output CSV path (e.g. results/erlang_scheduler/a6000_single/war_slo_frontier.csv)")
